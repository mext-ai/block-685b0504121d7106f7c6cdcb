...
import { Sphere, Vector3, Group } from 'three'
...
export default function SphereCollider({ id, radius, octree, position, colliders, checkSphereCollisions, children }: SphereColliderProps) {
  ...
  function updateSphere(delta: number, octree: any, sphere: Sphere, velocity: Vector3) {
