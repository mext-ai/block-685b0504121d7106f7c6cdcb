...
export default function Player({ octree, colliders, ballCount }: PlayerProps) {
  ...
  function updatePlayer(camera: Camera, delta: number, octree: any, capsule: Capsule, playerVelocity: Vector3, playerOnFloor: boolean): boolean {
  ...
  function throwBall(camera: Camera, capsule: Capsule, playerDirection: Vector3, playerVelocity: Vector3, count: number) {
  ...
  function playerCollisions(capsule: Capsule, octree: any, playerVelocity: Vector3): boolean {
